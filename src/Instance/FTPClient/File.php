...
class File {
    ...
    /**
     * The constructor
     * @param \PHPFuser\Instance\FTPClient $client
     * @param \PHPFuser\Instance\FTPClient\Bridge $bridge
     * @param string $dir
     * @param string $line
     * @param string $RPS
     */
    public function __construct(\PHPFuser\Instance\FTPClient $client, string $dir, string $line) {
        $this->dir = $dir;
        $this->line = $line;
        $this->validate();
    }
