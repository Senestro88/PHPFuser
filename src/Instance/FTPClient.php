...
class FTPClient
{
    ...
    /**
     * @var \PHPFuser\Instance\FTPClient\Bridge
     */
    private ?\PHPFuser\Instance\FTPClient\Bridge $bridge = null;
    ...
    public function __construct()
    {
        ...
        if(!extension_loaded('ftp')) {
            throw new \PHPFuser\Exceptions\Exception('FTP extension is not loaded!');
        }
    }
